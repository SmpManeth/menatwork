    ...
    <div class="max-w-7xl mx-auto">
        <div class="py-4 sm:py-6 md:py-8 border-round">
            <div class="bg-[#FFCC01] inline-block flex items-center rounded-2xl p-2 sm:p-4 md:p-6 mt-4 sm:mt-8">
                ...
                <span class="ps-3 sm:ps-5 font-bold text-sm sm:text-xl">STEP 01 - Create Account and Make the Registration Fee</span>
            </div>

            <p class="py-2 sm:py-4 md:py-6 text-sm sm:text-base md:text-lg">
                Please enter your details to create the account. Your account logins will be emailed to your given email address.
                When you start the registration process, you have to pay a registration fee of $30. Fill your information and click
                the button below, then you will be redirected to the payment gateway where you can make an online payment using your
            ...
            <form action="{{ route('session') }}" method="POST">
                ...
                <div class="mt-4 sm:mt-6 md:mt-8 grid grid-cols-1 gap-4 sm:grid-cols-6 gap-x-2 gap-y-4 sm:gap-x-4 sm:gap-y-6">
                    ...
                    <div class="sm:col-span-6 w-2/5 mx-auto">
                        <button class="bg-[#FFCC01] w-full sm:w-[32rem] uppercase text-black-50 px-6 sm:px-12 py-2 sm:py-3 rounded-3xl text-sm sm:text-base" type="submit">Make the Registration Free & Create Account</button>
                    </div>
