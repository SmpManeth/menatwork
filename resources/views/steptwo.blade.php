    ...
    <div class="max-w-7xl mx-auto">
        <div class="py-4 sm:py-6 md:py-8 border-round">
            <div class="bg-[#FFCC01] inline-block flex items-center rounded-2xl p-2 sm:p-4 md:p-6 mt-4 sm:mt-8">
                ...
                <span class="ps-3 sm:ps-5 font-bold text-sm sm:text-xl">STEP 02 - Upload Necessary Documents and Your CV</span>
            </div>

            <p class="py-2 sm:py-4 md:py-6 text-sm sm:text-base md:text-lg">
                Please follow the given instructions and upload the correct documents to avoid any delays in the registration process. We recommend you to arrange all the documents first and then start uploading. </p>
            ...
            <form action="{{ route('step-two') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 grid-cols-2">
                    <div>
                        <p>Upload Your Passport, Colour Scanned Copy (jpg or pdf)</p>
                        <div class="flex items-center justify-center w-full">
                            <label for="passport_copy" class="flex flex-col items-center justify-center w-full h-28 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2" />
                                    </svg>
                                    <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload</span> UPLOAD PASSPORT COPY</p>
                    ...
                    <div>
                        <p>Upload Passport Size Colour Photo of You</p>
                        <div class="flex items-center justify-center w-full">
                            <label for="photo" class="flex flex-col items-center justify-center w-full h-28 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2" />
                                    </svg>
                                    <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload</span> UPLOAD YOUR PHOTO</p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">SVG, PNG, JPG or GIF (MAX. 800x400px)</p>
                                </div>
                ...
                <br><br>
                <p>Upload Your Passport, Colour Scanned Copy (jpg or pdf)</p>
                <p>You have the option to apply for a Police Clearance Report online. To initiate the application process, please visit the provided link and complete the requisite information. Please be aware that it may take several weeks to receive the Police Clearance Report. However, there is no need to delay any further; once you have submitted the form and formally requested the Police Clearance Report, please capture a screenshot of the confirmation window indicating that your requisition has been accepted. You may then proceed to upload the screenshot here.</p>
                <div class="grid gap-4 grid-cols-2">
                    <div class="bg-[black] h-12 inline-block flex items-center">
                        <p class="text-[#FFCC01] mx-auto w-fit  ">https://www.police.lk/?page_id=3275</p>
                    </div>
